# Design convergence workflow decision ledger
...
This ledger preserves workflow-design decisions while the replacement skill is being designed. It is not the final normative skill text.
