...
func TestValidateRecordsDiagnosticCategories(t *testing.T) {
	root := t.TempDir()
	writeTestFile(t, root, "records/adr/001-valid.md", "# ADR-001: Valid\n- **status**: accepted\n- **depends_on**:\n- **supersedes**:\n")
	writeTestFile(t, root, "records/adr/002-bad-status-and-links.md", "# ADR-002: Bad status and links\n- **status**: draft\n- **depends_on**: ADR-999\n- **supersedes**: ADR-998\n- **migrated_to_spec**: tomorrow\n")
	writeTestFile(t, root, "records/adr/003-invalid-h1.md", "# 003: Invalid H1\n- **status**: accepted\n")
	writeTestFile(t, root, "records/adr/004-mismatch.md", "# ADR-005: Mismatch\n- **status**: accepted\n")
	writeTestFile(t, root, "records/adr/006-duplicate-a.md", "# ADR-006: Duplicate A\n- **status**: accepted\n")
	writeTestFile(t, root, "records/adr/106-duplicate-b.md", "# ADR-006: Duplicate B\n- **status**: accepted\n")
	writeTestFile(t, root, "records/spec/invalid-h1.md", "---\nstatus: draft\ndesign_record:\n  id: SPEC-invalid-h1\n  kind: spec\n---\n## Missing H1\n")
	writeTestFile(t, root, "records/spec/bad-status.md", "---\nstatus: accepted\ndesign_record:\n  id: SPEC-bad-status\n  kind: spec\n---\n# Bad status\n")
	writeTestFile(t, root, "records/spec/status-mismatch.md", "---\nstatus: draft\ndesign_record:\n  id: SPEC-status-mismatch\n  kind: spec\n  status: confirmed\n---\n# Status mismatch\n")
	writeTestFile(t, root, "records/spec/missing-dep.md", "---\nstatus: draft\ndepends_on:\n  - docs/adr/997-policy-path-only.md\ndesign_record:\n  id: SPEC-missing-dep\n  kind: spec\n  depends_on:\n    - ADR-996\n---\n# Missing dep\n")

	idx := buildTestIndex(t, root)
	idx.PathIssues = append(idx.PathIssues, PathIssue{Path: "records/adr/404-missing.md", Operation: "read", Err: errors.New("file does not exist")})
	...
	assertDiagnosticPath(t, resp.Diagnostics, DiagnosticFilenameIDMismatch, "records/adr/004-mismatch.md")
	assertDiagnosticPath(t, resp.Diagnostics, DiagnosticInvalidH1Title, "records/adr/003-invalid-h1.md")
	assertDiagnosticPath(t, resp.Diagnostics, DiagnosticInvalidH1Title, "records/spec/invalid-h1.md")
	assertDiagnosticPath(t, resp.Diagnostics, DiagnosticInvalidStatusForKind, "records/adr/002-bad-status-and-links.md")
	assertDiagnosticPath(t, resp.Diagnostics, DiagnosticInvalidStatusForKind, "records/spec/bad-status.md")
	assertDiagnosticPath(t, resp.Diagnostics, DiagnosticSpecStatusMismatch, "records/spec/status-mismatch.md")
	assertDiagnosticPath(t, resp.Diagnostics, DiagnosticInvalidMigratedToSpec, "records/adr/002-bad-status-and-links.md")
	assertDiagnosticPath(t, resp.Diagnostics, DiagnosticMissingRecordPath, "records/adr/404-missing.md")
...
func TestValidateRecordsAllowsMultipleDiagnosticsForOneRecord(t *testing.T) {
	root := t.TempDir()
	writeTestFile(t, root, "records/adr/001-bad.md", "# ADR-001: Bad\n- **status**: draft\n- **depends_on**: ADR-999\n- **supersedes**: ADR-998\n- **migrated_to_spec**: tomorrow\n")
...
func TestValidateRecordsOKWhenNoErrorDiagnostics(t *testing.T) {
	root := t.TempDir()
	writeTestFile(t, root, "records/adr/001-valid.md", "# ADR-001: Valid\n- **status**: accepted\n- **depends_on**:\n- **supersedes**:\n")
	writeTestFile(t, root, "records/spec/valid.md", "---\nstatus: draft\ndesign_record:\n  id: SPEC-valid\n  kind: spec\n  depends_on:\n    - ADR-001\n---\n# Valid spec\n")
	writeTestFile(t, root, "records/requirements/mcp/REQ-MCP-003-valid.md", "# REQ-MCP-003: Valid requirement\n- **id**: REQ-MCP-003\n- **status**: accepted\n- **date**: 2026-05-25\n- **source_refs**:\n  - ADR-001\n- **work_items**:\n  - WORK-MCP-003\n\n## Requirement\n\nRequirement content.\n\n## Required Outcome\n\nOutcome content.\n")
	writeTestFile(t, root, "records/work-items/mcp/WORK-MCP-003-valid.md", "# WORK-MCP-003: Valid work item\n- **id**: WORK-MCP-003\n- **status**: not_started\n- **date**: 2026-05-26\n- **source_requirement**: REQ-MCP-003\n- **impact_refs**:\n  - ADR-001\n- **tasks**:\n  - TASK-MCP-003-01\n")
	writeTestFile(t, root, "records/tasks/mcp/TASK-MCP-003-01-valid.md", "# TASK-MCP-003-01: Valid task\n- **id**: TASK-MCP-003-01\n- **status**: not_started\n- **date**: 2026-05-26\n- **work_item**: WORK-MCP-003\n- **source_requirement**: REQ-MCP-003\n- **estimate**: 0.5d\n- **depends_on**:\n- **outputs**:\n  - test\n")
...
func TestValidateRecordsWorkflowStatusAndParseDiagnostics(t *testing.T) {
	root := t.TempDir()
	writeTestFile(t, root, "records/requirements/mcp/REQ-MCP-001-bad-status.md", "# REQ-MCP-001: Bad requirement status\n- **id**: REQ-MCP-001\n- **status**: not_started\n- **date**: 2026-05-25\n- **source_refs**:\n- **work_items**:\n")
	writeTestFile(t, root, "records/work-items/mcp/WORK-MCP-001-bad-status.md", "# WORK-MCP-001: Bad work status\n- **id**: WORK-MCP-001\n- **status**: accepted\n- **date**: 2026-05-26\n- **source_requirement**: REQ-MCP-001\n- **impact_refs**:\n- **tasks**:\n")
	writeTestFile(t, root, "records/tasks/mcp/TASK-MCP-001-01-bad-status.md", "# TASK-MCP-001-01: Bad task status\n- **id**: TASK-MCP-001-01\n- **status**: accepted\n- **date**: 2026-05-26\n- **work_item**: WORK-MCP-001\n- **source_requirement**: REQ-MCP-001\n- **estimate**: 0.5d\n- **depends_on**:\n- **outputs**:\n")
	writeTestFile(t, root, "records/tasks/mcp/TASK-mcp-001-02-invalid.md", "# TASK-mcp-001-02: Invalid task ID\n- **id**: TASK-mcp-001-02\n- **status**: not_started\n")
	writeTestFile(t, root, "records/requirements/mcp/REQ-MCP-002-mismatch.md", "# REQ-MCP-002: Mismatch\n- **id**: REQ-MCP-003\n- **status**: accepted\n")
...
func TestValidateRecordsWorkflowMetadataStrictness(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			path:     "records/requirements/mcp/REQ-MCP-006-test.md",
		...
		},
		{
			...
			path:     "records/work-items/mcp/WORK-MCP-006-test.md",
		...
		},
		{
			...
			kind:     RecordKindTask,
			path:     "records/tasks/mcp/TASK-MCP-006-04-test.md",
	...
	tests := []struct {
		...
		},
		{
			...
			records: []Record{
				...
				{ID: "WORK-MCP-003", NormalizedID: "WORK-MCP-003", Kind: RecordKindRequirement, Title: "Wrong actual kind", Status: RecordStatusAccepted, Path: "records/requirements/mcp/WORK-MCP-003-wrong.md", Requirement: &RequirementDetail{WorkItems: []string{}}},
			},
			recordID: "REQ-MCP-003",
			field:    "work_items",
			value:    "WORK-MCP-003",
...
func TestValidateRecordsInvestigationReferenceDiagnostics(t *testing.T) {
	...
	assertInvestigationDiagnostic(t, resp.Diagnostics, DiagnosticNoncanonicalSourceRef, DiagnosticSeverityError, "source_refs", "records/adr/001-valid.md", "noncanonical")
	...
	assertInvestigationDiagnostic(t, resp.Diagnostics, DiagnosticNoncanonicalFollowUpResult, DiagnosticSeverityError, "follow_up_results", "records/spec/trace.md", "noncanonical")
	...
	assertInvestigationDiagnostic(t, resp.Diagnostics, DiagnosticNoncanonicalFollowUpCandidate, DiagnosticSeverityInfo, "follow_up_candidates", "records/spec/future.md", "noncanonical")
...
func TestValidateRecordsRejectsInvalidSemanticRefForms(t *testing.T) {
	root := t.TempDir()
	writeTestFile(t, root, "records/spec/invalid.md", "---\nstatus: draft\nsemantic_refs:\n  - Spec:trace\n  - 'spec:'\n  - spec:trace/\n  - spec:trace..broken\n\ndesign_record:\n  id: SPEC-invalid\n  kind: spec\n  status: draft\n---\n# Invalid refs\n")
...
func TestValidateRecordsDuplicateTargetsDoNotAddFieldSpecificAmbiguousDiagnostics(t *testing.T) {
	idx := &Index{
		Records: []Record{
			...
			{ID: "SPEC-a", NormalizedID: "SPEC-A", Kind: RecordKindSpec, Title: "A", Status: RecordStatusDraft, Path: "records/spec/a.md", Spec: &SpecDetail{}, SemanticRefs: []SemanticRefDecl{{Ref: "spec:trace.duplicate", Path: "records/spec/a.md", TargetType: SemanticTargetDocument}}},
			{ID: "SPEC-b", NormalizedID: "SPEC-B", Kind: RecordKindSpec, Title: "B", Status: RecordStatusDraft, Path: "records/spec/b.md", Spec: &SpecDetail{}, SemanticRefs: []SemanticRefDecl{{Ref: "spec:trace.duplicate", Path: "records/spec/b.md", TargetType: SemanticTargetDocument}}},
			{ID: "INV-DOCS-001", NormalizedID: "INV-DOCS-001", Kind: RecordKindInvestigation, Title: "Investigation", Status: RecordStatusConcluded, Path: "records/investigations/docs/INV-DOCS-001-test.md", Investigation: &InvestigationDetail{SourceRefs: []string{"ADR-001", "spec:trace.duplicate"}, FollowUpCandidates: []string{}}},
		},
	}
	idx.SemanticRefs = collectSemanticRefs(idx.Records)
	idx.SemanticRefSources = []SemanticRefSource{
		{Path: "records/spec/a.md", RecordID: "SPEC-a", Decls: idx.Records[2].SemanticRefs},
		{Path: "records/spec/b.md", RecordID: "SPEC-b", Decls: idx.Records[3].SemanticRefs},
	}
...
func TestValidateRecordsSpecStatusMismatchRequiresBothStatuses(t *testing.T) {
	root := t.TempDir()
	writeTestFile(t, root, "records/spec/missing-top-level-status.md", "---\ndesign_record:\n  id: SPEC-missing-top-level-status\n  kind: spec\n  status: draft\n---\n# Missing top-level status\n")
...
func TestValidateRecordsADRFilenameNumberMissingIsMismatch(t *testing.T) {
	root := t.TempDir()
	writeTestFile(t, root, "records/adr/foo.md", "# ADR-001: Example\n- **status**: accepted\n")
...
func TestValidateRecordsKindFilter(t *testing.T) {
	root := t.TempDir()
	writeTestFile(t, root, "records/adr/001-decision.md", "# ADR-001: Decision\n- **status**: draft\n")
	writeTestFile(t, root, "records/spec/spec.md", "---\nstatus: accepted\ndesign_record:\n  id: SPEC-bad\n  kind: spec\n---\n# Spec\n")
	writeTestFile(t, root, "records/tasks/mcp/TASK-MCP-003-01-task.md", "# TASK-MCP-003-01: Task\n- **id**: TASK-MCP-003-01\n- **status**: accepted\n- **date**: 2026-05-26\n- **work_item**: WORK-MCP-003\n- **source_requirement**: REQ-MCP-003\n- **estimate**: 0.5d\n- **depends_on**:\n- **outputs**:\n")
...
func TestValidateRecordsIDRangeFilter(t *testing.T) {
	root := t.TempDir()
	writeTestFile(t, root, "records/adr/001-one.md", "# ADR-001: One\n- **status**: accepted\n")
	writeTestFile(t, root, "records/adr/002-two.md", "# ADR-002: Two\n- **status**: draft\n")
	writeTestFile(t, root, "records/adr/003-three.md", "# ADR-003: Three\n- **status**: draft\n")
	writeTestFile(t, root, "records/spec/bad.md", "---\nstatus: accepted\ndesign_record:\n  id: SPEC-bad\n  kind: spec\n---\n# Bad\n")
...
func TestValidateRecordsWorkflowIDRangeFilter(t *testing.T) {
	records := []Record{
		{ID: "REQ-DATA-001", NormalizedID: "REQ-DATA-001", Kind: RecordKindRequirement, Title: "Req 1", Status: RecordStatusCaptured, Path: "records/requirements/data/REQ-DATA-001-test.md", Requirement: &RequirementDetail{}},
		{ID: "REQ-DATA-002", NormalizedID: "REQ-DATA-002", Kind: RecordKindRequirement, Title: "Req 2", Status: RecordStatusNotStarted, Path: "records/requirements/data/REQ-DATA-002-test.md", Requirement: &RequirementDetail{}},
		{ID: "REQ-MCP-001", NormalizedID: "REQ-MCP-001", Kind: RecordKindRequirement, Title: "Req other domain", Status: RecordStatusNotStarted, Path: "records/requirements/mcp/REQ-MCP-001-test.md", Requirement: &RequirementDetail{}},
		{ID: "WORK-DATA-001", NormalizedID: "WORK-DATA-001", Kind: RecordKindWorkItem, Title: "Work 1", Status: RecordStatusNotStarted, Path: "records/work-items/data/WORK-DATA-001-test.md", WorkItem: &WorkItemDetail{}},
		{ID: "WORK-DATA-002", NormalizedID: "WORK-DATA-002", Kind: RecordKindWorkItem, Title: "Work 2", Status: RecordStatusAccepted, Path: "records/work-items/data/WORK-DATA-002-test.md", WorkItem: &WorkItemDetail{}},
		{ID: "WORK-MCP-002", NormalizedID: "WORK-MCP-002", Kind: RecordKindWorkItem, Title: "Work other domain", Status: RecordStatusAccepted, Path: "records/work-items/mcp/WORK-MCP-002-test.md", WorkItem: &WorkItemDetail{}},
		...
		{ID: "TASK-MCP-007-02", NormalizedID: "TASK-MCP-007-02", Kind: RecordKindTask, Title: "Task 2", Status: RecordStatusAccepted, Path: "records/tasks/mcp/TASK-MCP-007-02-test.md", Task: &TaskDetail{}},
		{ID: "TASK-MCP-008-01", NormalizedID: "TASK-MCP-008-01", Kind: RecordKindTask, Title: "Task other work", Status: RecordStatusAccepted, Path: "records/tasks/mcp/TASK-MCP-008-01-test.md", Task: &TaskDetail{}},
	}
...
func requirementTestRecord(id string, workItems []string) Record {
	return Record{
		...
		Path:         "records/requirements/mcp/" + id + "-test.md",
...
func workItemTestRecord(id, sourceRequirement string, tasks []string) Record {
	return Record{
		...
		Path:         "records/work-items/mcp/" + id + "-test.md",
...
func taskTestRecord(id, workItem, sourceRequirement string, dependsOn []string) Record {
	return Record{
		...
		Path:         "records/tasks/mcp/" + id + "-test.md",
		Task: &TaskDetail{
			WorkItem:          workItem,
			SourceRequirement: sourceRequirement,
			Estimate:          "0.5d",
...
func writeWorkflowHappyPathFixture(t *testing.T, root string) {
	...
	writeTestFile(t, root, "records/requirements/mcp/REQ-MCP-003-valid.md", "# REQ-MCP-003: Valid requirement\n- **id**: REQ-MCP-003\n- **status**: accepted\n- **date**: 2026-05-25\n- **source_refs**:\n- **work_items**:\n  - WORK-MCP-003\n\n## Requirement\n\nRequirement content.\n\n## Required Outcome\n\nOutcome content.\n")
	writeTestFile(t, root, "records/work-items/mcp/WORK-MCP-003-valid.md", "# WORK-MCP-003: Valid work item\n- **id**: WORK-MCP-003\n- **status**: in_progress\n- **date**: 2026-05-26\n- **source_requirement**: REQ-MCP-003\n- **impact_refs**:\n- **tasks**:\n  - TASK-MCP-003-01\n  - TASK-MCP-003-02\n")
	writeTestFile(t, root, "records/tasks/mcp/TASK-MCP-003-01-valid.md", "# TASK-MCP-003-01: First task\n- **id**: TASK-MCP-003-01\n- **status**: not_started\n- **date**: 2026-05-26\n- **work_item**: WORK-MCP-003\n- **source_requirement**: REQ-MCP-003\n- **estimate**: 0.5d\n- **depends_on**:\n- **outputs**:\n  - first\n")
	writeTestFile(t, root, "records/tasks/mcp/TASK-MCP-003-02-valid.md", "# TASK-MCP-003-02: Second task\n- **id**: TASK-MCP-003-02\n- **status**: not_started\n- **date**: 2026-05-26\n- **work_item**: WORK-MCP-003\n- **source_requirement**: REQ-MCP-003\n- **estimate**: 0.5d\n- **depends_on**:\n  - TASK-MCP-003-01\n- **outputs**:\n  - second\n")
}
...
func TestValidateRecordsRequiredNarrativeSections(t *testing.T) {
	...
	t.Run("work_item done missing Goal", func(t *testing.T) {
		...
		writeTestFile(t, root, "records/work-items/mcp/WORK-MCP-007-test.md", content)
	...
	t.Run("task done required sections enforced", func(t *testing.T) {
		for _, sectionName := range []string{"Goal", "Work", "Done condition", "Verification", "Evidence"} {
			...
			t.Run("missing "+sectionName, func(t *testing.T) {
				...
				writeTestFile(t, root, "records/tasks/mcp/TASK-MCP-007-01-test.md", body.String())
	...
	t.Run("requirement accepted Requirement required", func(t *testing.T) {
		...
		writeTestFile(t, root, "records/requirements/mcp/REQ-MCP-007-test.md", content)
	...
	t.Run("task todo empty Evidence not checked", func(t *testing.T) {
		...
		writeTestFile(t, root, "records/tasks/mcp/TASK-MCP-007-01-test.md", content)
		resp, err := ValidateRecords(context.Background(), buildTestIndex(t, root), ValidateRecordsRequest{Kind: RecordKindTask})
		if err != nil {
			t.Fatalf("ValidateRecords: %v", err)
		}
...
func TestRequiredSectionHeadingCaseMismatchDiagnostics(t *testing.T) {
	...
	t.Run("gated task emits strict missing error plus repair info", func(t *testing.T) {
		...
		writeTestFile(t, root, "records/tasks/mcp/TASK-MCP-021-01-heading-case-mismatch.md", content)
...
func writeHeadingCaseMismatchWorkflowParents(t *testing.T, root string) {
	t.Helper()
	writeTestFile(t, root, "records/requirements/mcp/REQ-MCP-021-heading-case-mismatch.md", "# REQ-MCP-021: Heading case mismatch\n\n- **id**: REQ-MCP-021\n- **status**: captured\n- **date**: 2026-06-05\n- **source_refs**:\n- **work_items**:\n  - WORK-MCP-021\n")
	writeTestFile(t, root, "records/work-items/mcp/WORK-MCP-021-heading-case-mismatch.md", "# WORK-MCP-021: Heading case mismatch\n\n- **id**: WORK-MCP-021\n- **status**: not_started\n- **date**: 2026-06-05\n- **source_requirement**: REQ-MCP-021\n- **impact_refs**:\n- **tasks**:\n  - TASK-MCP-021-01\n")
}
