...
Defines the two-layer v1 record ID model: public ID (externally visible, namespace-prefixed) and bare ID (internal validation form after prefix stripping).
...
When bare ID grammar forms appear in specs without explicit qualification, they refer to the internal validation rule — not the public tool contract form.
