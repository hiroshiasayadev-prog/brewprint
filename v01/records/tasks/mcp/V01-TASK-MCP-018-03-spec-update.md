# V01-TASK-MCP-018-03: Update spec and guidance for strict fields-required create contract

- **id**: V01-TASK-MCP-018-03
- **status**: done
- **date**: 2026-06-03
...
- `V01-TASK-MCP-018-01` / `V01-TASK-MCP-018-02` の review / impact result を前提に、valid / invalid input combinations を spec に反映する。
...
- Spec / guidance / V01-REQ-MCP-019 / V01-WORK-MCP-018 の boundary が矛盾していないことを確認する。
...
- Follow-up review confirmed both blocking findings are resolved and `V01-TASK-MCP-018-04` can proceed.
