# V01-TASK-MCP-019-02: Update tools spec for required heading case canonicalization

- **id**: V01-TASK-MCP-019-02
- **status**: done
- **date**: 2026-06-05
...
Update the Design Records MCP tools spec so V01-REQ-MCP-021 has a precise public contract before implementation.
...
- Review the updated spec section for consistency with V01-REQ-MCP-021 and V01-TASK-MCP-019-01 evidence.
...
- The review confirmed that V01-ADR-093 does not need an update.
...
Next step: proceed to `V01-TASK-MCP-019-03` for regression test creation.
