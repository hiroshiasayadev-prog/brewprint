# V01-TASK-MCP-021-02: update named_section_replace normalization contract

- **id**: V01-TASK-MCP-021-02
- **status**: done
- **date**: 2026-06-05
...
- Review the updated documentation against V01-REQ-MCP-022 acceptance criteria.
- Confirm excluded scope remains excluded.

## Evidence
2026-06-05: Contract documentation updated per V01-REQ-MCP-022.
...
V01-REQ-MCP-022 acceptance criteria verified against updated spec: all criteria covered.
...
Implementation note for V01-TASK-MCP-021-03:
