# V01-TASK-MCP-006-01: Current workflow metadata validation gap を整理する

- **id**: V01-TASK-MCP-006-01
- **status**: done
- **date**: 2026-06-01
...
- **outputs**:
  ...
  - Strictness decision input for V01-TASK-MCP-006-02

## Goal

V01-WORK-MCP-006 の判断前提として、Design Records MCP の workflow artifact metadata validation について、現行 public contract / authoring guidance / implementation / tests / runtime behavior の差分を evidence として整理する。
...
6. V01-TASK-MCP-006-02 で判断すべき strictness choice と unresolved points を列挙する。
...
- V01-TASK-MCP-006-02 に渡す decision input。

## Completion condition

V01-TASK-MCP-006-02 の public contract decision に進めるだけの evidence が揃い、未判断点が明示されている。

## Verification

- 2026-06-01: Codex review により、V01-TASK-MCP-006-02 に進めるだけの evidence review が揃っていることを確認した。
...
- V01-REQ-MCP-003 / V01-WORK-MCP-003 completion scope does not need reopening.

V01-TASK-MCP-006-02 decision points:
