...
- options matrix の評価基準が V01-REQ-MCP-026 § Required Outcome の acceptance criteria と対応している
...
- 既存 task レコード: `todo` 使用 0 件、`doing` 使用 1 件（V01-TASK-MCP-022-01 自身）
...
- 次: V01-ADR-094 起票（V01-ADR-092 を refine する形）
