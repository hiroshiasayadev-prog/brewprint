# V01-TASK-MCP-016-03: Implement required narrative section validation

- **id**: V01-TASK-MCP-016-03
- **status**: done
- **date**: 2026-06-03
...
- Apply the policy from `V01-TASK-MCP-016-01`.
- Emit diagnostics matching `V01-TASK-MCP-016-02`.
...
- `internal/designrecordsmcp/tools_call_test.go`: updated `toolsCallTestIndex()` fixtures for `V01-REQ-MCP-003` (accepted) and `V01-TASK-MCP-003-01` (done) to include required narrative sections and headings.
...
Runtime smoke and final close synchronization are intentionally deferred to `V01-TASK-MCP-016-04`.
