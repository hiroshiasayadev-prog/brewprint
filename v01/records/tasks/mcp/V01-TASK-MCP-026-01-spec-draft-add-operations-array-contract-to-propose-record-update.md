# V01-TASK-MCP-026-01: spec draft — add operations array contract to propose_record_update

- **id**: V01-TASK-MCP-026-01
- **status**: done
- **date**: 2026-06-07
...
tools.md の `propose_record_update` セクションに `operations` 配列 contract が追記され、ユーザーが内容を確認して V01-TASK-MCP-026-02 への GO を出した。

## Verification

追記内容が V01-REQ-MCP-025 の acceptance criteria と矛盾していないことを照合する。
...
Codex レビュー 4 件（cardinality 未定義・body cache retry 未記述・diagnostic catalog 未登録・normative language 弱い）を全対応。ユーザーから V01-TASK-MCP-026-02 への GO を得た。
