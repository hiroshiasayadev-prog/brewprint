...
Implement the `list_authoring_guides` and `get_authoring_guidance` MCP tools according to the V01-WORK-MCP-005 / V01-REQ-MCP-005 contract without changing existing Design Records record retrieval, validation, or reference resolution behavior.
