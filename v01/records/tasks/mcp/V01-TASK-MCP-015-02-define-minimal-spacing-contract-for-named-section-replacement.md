# V01-TASK-MCP-015-02: Define minimal spacing contract for named section replacement

- **id**: V01-TASK-MCP-015-02
- **status**: done
- **date**: 2026-06-03
...
- Compare the decision against `V01-REQ-MCP-016` Required Outcome and Explicitly Excluded Scope.
...
- V01-REQ-MCP-016 Required Outcome は「blank line を維持する」であり、spec に公式の separator rule section を追加しなくても、実装とテストで契約を表現できる。
