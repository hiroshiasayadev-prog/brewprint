# V01-TASK-RESOLVE-001-02: resolver symbol table / index を public node と file-private sub node で分離する

- **id**: V01-TASK-RESOLVE-001-02
- **status**: done
- **date**: 2026-05-31
...
- V01-ADR-078 の MCP synthetic ID 方針に反する public QID 化を増やさない。
...
- 後続 `V01-TASK-RESOLVE-001-03` で追加する regression tests が通ることを確認する。
