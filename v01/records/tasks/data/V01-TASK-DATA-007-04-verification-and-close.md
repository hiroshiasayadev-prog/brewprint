# V01-TASK-DATA-007-04: Verification and close

- **id**: V01-TASK-DATA-007-04
- **status**: done
- **date**: 2026-06-02
...
- **outputs**:
  - V01-WORK-DATA-007 close synchronization
  - V01-REQ-DATA-005 acceptance evidence
  - Final validation evidence

## Goal

Close V01-WORK-DATA-007 after V01-ADR-074 acceptance, DAG view spec alignment, renderer implementation, fixture / golden updates, and verification evidence are complete.

## Work

- Confirm V01-TASK-DATA-007-01 through V01-TASK-DATA-007-03 are done.
- Confirm V01-ADR-074 is accepted and aligned to V01-REQ-DATA-005 / V01-WORK-DATA-007.
- Confirm DAG view spec owns the accepted asset TypeRef hint render rule.
- Confirm renderer implementation and UC-001 golden evidence were completed by V01-TASK-DATA-007-03.
- Confirm tests and UC validation passed.
- Mark V01-WORK-DATA-007 as done and record close evidence.
- Mark V01-REQ-DATA-005 as accepted and record close evidence.
- Validate task / work item / requirement / ADR metadata.

## Done Condition

- V01-WORK-DATA-007 status is `done`.
- V01-REQ-DATA-005 status is `accepted`.
- Close evidence records the implementation result and verification commands.
- Design Records MCP validation passes for V01-TASK-DATA-007-04, V01-WORK-DATA-007, V01-REQ-DATA-005, and V01-ADR-074.
- No implementation, fixture, golden, UC YAML, TypeRef compatibility, or diagnostic changes are performed by this close task.

## Verification

- Design Records MCP validation for V01-TASK-DATA-007-03 passed before close.
- Design Records MCP validation for V01-WORK-DATA-007 passed before close.
- V01-TASK-DATA-007-03 implementation evidence reports `go test ./...` PASS.
- V01-TASK-DATA-007-03 implementation evidence reports UC-001 / UC-002 validate cleanly with 0 errors and 0 warnings.
...
- V01-TASK-DATA-007-01: done; V01-ADR-074 acceptance / split review completed with `revise-before-acceptance` input.
- V01-TASK-DATA-007-02: done; V01-ADR-074 revised to accepted, collision inventory completed, and DAG view spec aligned.
- V01-TASK-DATA-007-03: done; renderer and fixture update completed.
- V01-ADR-074: accepted; active boundary is V01-REQ-DATA-005 / V01-WORK-DATA-007.

### Implementation result confirmed from V01-TASK-DATA-007-03
...
- Design Records MCP validation for V01-TASK-DATA-007-03 passed.
- Design Records MCP validation for V01-WORK-DATA-007 passed.

### Final close status

V01-WORK-DATA-007 is closed as done.
V01-REQ-DATA-005 is accepted.
