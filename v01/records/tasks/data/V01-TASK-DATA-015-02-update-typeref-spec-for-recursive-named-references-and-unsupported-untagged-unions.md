# V01-TASK-DATA-015-02: Update TypeRef spec for recursive named references and unsupported untagged unions

- **id**: V01-TASK-DATA-015-02
- **status**: done
- **date**: 2026-06-07
...
Reflect the `V01-TASK-DATA-015-01` contract boundary decision into the TypeRef specification.
...
- Traceability back to `V01-REQ-DATA-008`, `V01-WORK-DATA-015`, and `V01-TASK-DATA-015-01`.
...
- Review the edited spec section for consistency with V01-ADR-073 and `V01-TASK-DATA-015-01`.
...
- `validate_records` for `V01-TASK-DATA-015-02`: PASS.
- `validate_records` for `V01-TASK-DATA-015-01` through `V01-TASK-DATA-015-02`: PASS.
