# V01-TASK-DATA-006-02: UC-002 model-file helper YAML migration

- **id**: V01-TASK-DATA-006-02
- **status**: done
- **date**: 2026-06-01
...
This task does not migrate task-file `query_result:any` patterns, because V01-TASK-DATA-006-01 classified those as deferred under the accepted DATA-004 / V01-REQ-DATA-003 task `params[].model` private-helper policy.
...
- `list_objects_object` identity semantics remain V01-ADR-078+ / MCP identity follow-up scope.
