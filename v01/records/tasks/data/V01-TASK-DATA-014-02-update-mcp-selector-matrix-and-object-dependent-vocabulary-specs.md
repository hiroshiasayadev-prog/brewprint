# V01-TASK-DATA-014-02: Update MCP selector matrix and object-dependent vocabulary specs

- **id**: V01-TASK-DATA-014-02
- **status**: done
- **date**: 2026-06-07
...
Reflect the `V01-TASK-DATA-014-01` boundary decision into the MCP schema and relevant MCP tool specs.
...
- Review the changed spec text against `V01-TASK-DATA-014-01` Evidence.
...
- Run Design Records MCP validation for this task and `V01-WORK-DATA-014`.
...
- Compared the changes against `V01-TASK-DATA-014-01` Evidence.
...
- Addressed Codex review finding for stale `V01-WORK-DATA-014` task flow by listing current tasks and remaining split.
