# V01-TASK-DATA-010-03: Tagged union raw model / resolver / validation implementation

- **id**: V01-TASK-DATA-010-03
- **status**: done
- **date**: 2026-06-03
...
This task follows V01-TASK-DATA-010-02, which accepted and specified the tagged union / discriminator payload contract in V01-ADR-073 and the active specs.
...
- Preserve existing `any` wildcard behavior from V01-ADR-060.
