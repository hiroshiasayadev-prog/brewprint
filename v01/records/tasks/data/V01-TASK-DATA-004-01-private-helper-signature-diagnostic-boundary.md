# V01-TASK-DATA-004-01: Private helper signature diagnostic boundary

- **id**: V01-TASK-DATA-004-01
- **status**: done
- **date**: 2026-05-31
...
This task records how the accepted V01-REQ-DATA-003 policy becomes a concrete validation rule before spec wording and implementation begin.

## Work

- Review V01-REQ-DATA-003 accepted policy.
...
- Inputs for V01-TASK-DATA-004-02 spec alignment.
...
- V01-TASK-DATA-004-02 has concrete input for spec / diagnostics wording.
- No spec, implementation, fixture, render, or test changes are performed.

## Verification

- Confirm V01-REQ-DATA-003 accepted policy is preserved.
- Confirm V01-WORK-DATA-003 is not pulled into scope.
...
- The diagnostic id follows the existing diagnostics style and the prior V01-TASK-DATA-002-03 candidate name recorded in `docs/spec/diagnostics.md`.
...
V01-TASK-DATA-004-02 should update the relevant specs to record:
...
- V01-REQ-DATA-003 accepted policy is preserved.
- V01-WORK-DATA-003 is not pulled into scope.
