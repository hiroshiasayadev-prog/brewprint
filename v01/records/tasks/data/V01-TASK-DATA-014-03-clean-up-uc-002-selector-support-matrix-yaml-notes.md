# V01-TASK-DATA-014-03: Clean up UC-002 selector support matrix YAML notes

- **id**: V01-TASK-DATA-014-03
- **status**: done
- **date**: 2026-06-07
...
- Cover the `V01-REQ-DATA-007` candidates N-020, N-031, N-037, N-040, and N-042.
...
- `docs/work-items/data/WORK-DATA-014-selector-support-matrix-and-object-dependent-vocabulary.md`
  - Updated Task Flow to include `V01-TASK-DATA-014-03` without duplicating task completion status from task artifacts.
...
- Reviewed changed YAML notes against MCP schema/tool specs updated by `V01-TASK-DATA-014-02`.
