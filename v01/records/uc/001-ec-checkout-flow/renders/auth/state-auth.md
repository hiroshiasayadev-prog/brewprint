...
| login_succeeded | internal | — | auth.task.login 成功時にFSM runtimeが発火。返却された token を運ぶ（V01-ADR-034） |
| login_failed | internal | — | auth.task.login 失敗時にFSM runtimeが発火（V01-ADR-034） |
