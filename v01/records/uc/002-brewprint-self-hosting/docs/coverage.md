...
- UC-002 Phase A validate は `V01-TASK-SELFHOST-001-01` で ok 済み
- canonical renders は11 files生成済み
- generated render review は `V01-TASK-SELFHOST-001-02` で完了し、canonical fixture として採用可能と判定済み
...
- `go test ./...`: pass (`V01-TASK-SELFHOST-001-01`)
- UC-002 Phase A validate: `ok` (`V01-TASK-SELFHOST-001-01`)
- canonical render generation: `rendered 11 file(s)` (`V01-TASK-SELFHOST-001-01`)
- generated render review: blockingなし、canonical fixture として採用可能 (`V01-TASK-SELFHOST-001-02`)
- temp render comparison: canonical と file list / byte-level content が一致 (`V01-TASK-SELFHOST-001-02`)
...
次の未完項目は、`V01-WORK-SELFHOST-001` の範囲外として扱う。
