# V01-REQ-MCP-007: list_records workflow artifact range filter support
...
For example, checking whether `V01-WORK-DATA-004` is already occupied should be expressible as a workflow artifact query rather than falling back to filesystem directory listing or exact-ID probing.
...
- `V01-REQ-MCP-001` .. `V01-REQ-MCP-010`
- `V01-WORK-DATA-001` .. `V01-WORK-DATA-010`
- `V01-TASK-DATA-004-01` .. `V01-TASK-DATA-004-99`

Examples that should remain invalid unless a later contract explicitly defines ordering:

- `V01-WORK-DATA-001` .. `V01-WORK-MCP-010`
- `V01-REQ-DATA-001` .. `TASK-DATA-010`
- `SPEC-*` ranges
...
- Implemented by `V01-WORK-MCP-007`.
