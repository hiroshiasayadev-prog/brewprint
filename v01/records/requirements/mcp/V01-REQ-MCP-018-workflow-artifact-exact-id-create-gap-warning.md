# V01-REQ-MCP-018: workflow artifact exact ID create gap warning
...
- `V01-WORK-MCP-014` を exact ID で起票した結果、既存の `V01-WORK-MCP-011` / `V01-WORK-MCP-012` の次に `V01-WORK-MCP-014` が作成され、`V01-WORK-MCP-013` が欠番になった。
