# V01-REQ-MCP-008: Design Records MCP authoring transaction support
...
That split weakens dogfooding because assistants are incentivized to inspect and manipulate concrete files even when the user intent is expressed in artifact terms such as `REQ-MCP-new`, `V01-WORK-DATA-010`, or `V01-TASK-DATA-010-01`.
...
2026-06-02: Requirement accepted after V01-WORK-MCP-008 completion.
...
- `V01-ADR-093` accepted the Design Records MCP authoring transaction model.
...
- `V01-TASK-MCP-008-01` through `V01-TASK-MCP-008-07` are done.
...
- Design Records validation returned ok for `V01-ADR-093`, `V01-REQ-MCP-008`, `V01-WORK-MCP-008`, and `V01-TASK-MCP-008-07`.

Explicitly deferred:

- Spec skeleton creation / `SPEC-new` support is outside this MVP and captured separately as `V01-REQ-MCP-010`.
