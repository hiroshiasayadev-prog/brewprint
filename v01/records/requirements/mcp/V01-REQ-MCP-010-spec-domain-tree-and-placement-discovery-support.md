...
During V01-WORK-MCP-008 spec reflection review, spec skeleton creation was found to require placement information that the current MCP public surface does not provide.
...
This requirement captures the missing spec placement discovery capability that was intentionally excluded from V01-REQ-MCP-008 MVP authoring transaction support.
