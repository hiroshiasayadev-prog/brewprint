...
## Evidence
- V01-REQ-PRODUCT-001 が定義した app namespace / domain namespace モデルの物理表現がまだ存在しない。
...
- V01-REQ-PRODUCT-001 は「namespace-first physical layout migration work」を将来の prerequisite 対象として明示していた。
