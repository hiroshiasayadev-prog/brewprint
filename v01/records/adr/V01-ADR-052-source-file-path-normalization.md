# V01-ADR-052: source.File.Path のプロジェクトルート相対 + slash正規化

- **status**: accepted
- **date**: 2026-04-29
- **depends on**: V01-ADR-043, V01-ADR-050
...
- V01-ADR-043 でプロジェクトのルートが定義されており、それを基点にすることで「ファイル位置」を一意に特定できる
...
- commit: 261ed60
- impl commit: tbd
- 参考: V01-ADR-043 §1, V01-ADR-050 §決定
