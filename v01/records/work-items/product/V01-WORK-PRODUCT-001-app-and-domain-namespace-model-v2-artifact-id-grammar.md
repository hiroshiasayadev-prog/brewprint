# V01-WORK-PRODUCT-001: App and domain namespace model の定義と v2 artifact ID grammar 仕様化

- **id**: V01-WORK-PRODUCT-001
- **status**: done
- **date**: 2026-06-07
...
- **impact_refs**:
  ...
  - V01-ADR-096
- **tasks**:
  - V01-TASK-PRODUCT-001-01
  - V01-TASK-PRODUCT-001-02
  - V01-TASK-PRODUCT-001-03
  - V01-TASK-PRODUCT-001-04

## Goal

app namespace と domain namespace を分離した namespace model を定義し、v2 artifact ID grammar を仕様化する。namespace catalog の初版を作成し、V01-REQ-PRODUCT-001 の Required Outcome を解消する。
...
- 既存 artifact の v2 ID への migration（V01-ADR-096 で非実施決定）
...
- V01-REQ-PRODUCT-001: work_items への本 WORK 反映
...
- V01-REQ-PRODUCT-001 に本 WORK が反映されている
...
- V01-REQ-PRODUCT-002 起票: domain namespace 内 subdomain grouping model
- V01-REQ-PRODUCT-001 の Required Outcome 5件全て充足
