# V01-WORK-MCP-029: Reflect workflow status-gated required section rules in authoring guides
...
- Minor finding 2: `V01-REQ-MCP-032` Evidence wording read as current-state evidence after the guide update; changed to historical wording with `Before this change,`.
...
- `V01-TASK-MCP-029-01` updated to `done` with review and patch evidence.
- `V01-WORK-MCP-029` updated to `done` with implementation, review, and patch evidence.
