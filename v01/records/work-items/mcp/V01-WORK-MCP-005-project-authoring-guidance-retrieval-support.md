# V01-WORK-MCP-005: Project authoring guidance retrieval support
...
- Known `go test ./...` render / manifest failures are outside V01-WORK-MCP-005 scope.
...
|---|---|---|
| source requirement | `V01-REQ-MCP-005` captured | This work item owns the discovery / retrieval flow |
...
```mermaid
flowchart TD
  T1["V01-TASK-MCP-005-01: Guidance catalog and boundary decision"]
  T2["V01-TASK-MCP-005-02: MCP tool / schema contract design"]
  T3["V01-TASK-MCP-005-03: MCP tool / schema spec update"]
  T4["V01-TASK-MCP-005-04: Implementation and tests"]
  T5["V01-TASK-MCP-005-05: doc-policy / README guide ID reference update"]
  T6["V01-TASK-MCP-005-06: Verification and close evidence"]
  T1 --> T2 --> T3 --> T4 --> T5 --> T6
```

## Task Candidates

- `V01-TASK-MCP-005-01`: Guidance catalog and boundary decision.
- `V01-TASK-MCP-005-02`: MCP tool / schema contract design.
- `V01-TASK-MCP-005-03`: MCP tool / schema spec update.
- `V01-TASK-MCP-005-04`: Implementation and tests.
- `V01-TASK-MCP-005-05`: doc-policy / README guide ID reference update.
- `V01-TASK-MCP-005-06`: Verification and close evidence.

`V01-TASK-MCP-005-01` through `V01-TASK-MCP-005-06` are materialized.
