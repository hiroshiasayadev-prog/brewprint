# V01-WORK-MCP-024: Document third-party dependency license notice policy
...
- Close V01-REQ-MCP-029 without introducing SBOM automation, vendoring, license replacement, or full historical dependency audit.
...
- V01-REQ-MCP-029 is accepted with close evidence.

## Evidence

- V01-TASK-MCP-024-01 completed the current notice target review for `github.com/pmezard/go-difflib` / `github.com/pmezard/go-difflib/difflib`.
- V01-TASK-MCP-024-02 created `docs/third-party-notices.md` and linked it from `docs/doc-policy.md`.
