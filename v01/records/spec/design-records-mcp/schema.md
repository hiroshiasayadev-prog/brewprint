...
design_record:
  id: V01-SPEC-design-records-mcp-schema
  kind: spec
  status: draft
  depends_on:
    - V01-ADR-076
...
> 由来: V01-ADR-076 §front matter 方針, V01-ADR-077 §get_record の責務
...
MVP では、V01-ADR-076 の ADR 向け `design_record` front matter 例は採用しない。
...
investigation は V01-ADR-086 の形式に従い、H1直下の箇条書きmetadataを読む。
...
For example, `domain: "mcp"` with `id: "V01-REQ-MCP-011"` resolves to canonical domain `MCP` and repository path domain `mcp`.
...
> 由来: V01-ADR-076 §front matter 方針, V01-ADR-077 §list_records の責務
...
> 由来: V01-ADR-076 §MVP対象, V01-ADR-087 §1, V01-ADR-092 §1
...
> 由来: V01-ADR-076 §front matter 方針, V01-ADR-077 §validate_records の責務, V01-ADR-086 §5, V01-ADR-091, V01-ADR-092, V01-ADR-094
...
> 由来: V01-ADR-077 §validate_records の責務, V01-ADR-091 §3・§6, V01-ADR-092 §4・§7
...
> 由来: V01-ADR-076 §front matter 方針, V01-ADR-077 §validate_records の責務
...
> 由来: V01-ADR-077 §validate_records の責務, V01-ADR-090 §Partial result / Ordering と duplicate requested ID, V01-ADR-092 §4〜§7, V01-REQ-MCP-017 / V01-TASK-MCP-016-01 required narrative section policy
...
- V01-ADR-050
- V01-ADR-067〜V01-ADR-077
- V01-ADR-086〜V01-ADR-088
