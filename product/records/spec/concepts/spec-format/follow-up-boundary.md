...
- **id**: `spec:product.concepts.spec_format.follow_up_boundary`
- **status**: accepted
- **date**: 2026-06-14
...
| follow-up | owns |
|---|---|
| PRODUCT-WORK-SPEC-002 | Done. Canonical ref contract, ref-first `## Topics`, and explicit compatibility exception decisions are recorded in `spec:product.concepts.spec_format.compatibility_exceptions`. |
...
| `spec:product.concepts.spec_format.validation_policy` | Defines validation ownership and temporary tooling boundary. |
| `spec:product.concepts.spec_format.spec_id_as_ref` | Defers alias, redirect, stale-ref, and derived-topic compatibility exceptions to PRODUCT-WORK-SPEC-002. |
