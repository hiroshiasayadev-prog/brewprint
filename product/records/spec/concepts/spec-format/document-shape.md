...
- **id**: `spec:product.concepts.spec_format.document_shape`
- **status**: accepted
- **date**: 2026-06-11
...
| `spec:product.concepts.spec_format.topics_table` | Defines the Index and Overview topic table contract. |
| `spec:product.concepts.spec_format.validation_policy` | Defines severity and parser-aware validation policy. |
