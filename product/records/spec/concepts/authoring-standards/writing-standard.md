...
- **id**: `spec:product.concepts.authoring_standards.writing_standard`
- **status**: accepted
- **date**: 2026-06-15
...
- Section title and heading format rules — those belong to `spec:product.concepts.spec_format.document_shape`.
...
| ref | relation |
|---|---|
| `spec:product.concepts.authoring_standards` | Parent Index for this spec. |
| `spec:product.concepts.spec_format.document_shape` | Section and heading format rules for spec records. |
