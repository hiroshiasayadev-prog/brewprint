...
- **id**: `spec:product.design_records.spec_format.validation_policy`
- **status**: accepted
- **date**: 2026-06-11
...
| `spec:product.design_records.spec_format.document_shape` | Defines H1, metadata, and required-section checks. |
| `spec:product.design_records.spec_format.topics_table` | Defines topic table checks. |
| `spec:product.design_records.spec_format.spec_id_as_ref` | Defines ID derivation and parent grammar checks. |
