...
- Tool API contracts — those belong to `spec:drmcp.design_records_mcp.tools.overview`.
- Prose style rules — those belong to `spec:product.design_records.authoring_standards.writing_standard`.
...
| Rule | Level |
|---|---|
| Follow `spec:product.design_records.authoring_standards.writing_standard` for all design record prose. | MUST |
...
| `spec:product.design_records.authoring_standards.writing_standard` | Prose style rules for design record authoring. |
| `spec:drmcp.design_records_mcp.tools.overview` | Authoritative DRMCP tool API contract. |
