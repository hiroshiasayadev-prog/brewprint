...
- **id**: `spec:product.design_records.authoring_standards.spec_authoring`
- **status**: draft
- **date**: 2026-06-23
...
This guide defines spec identity, file paths, file shape, metadata, kind selection, and author-facing inputs. The normative spec format contract is owned by `spec:product.design_records.spec_format` and its children; this guide provides the author-facing view.
...
- Normative spec format contract — owned by `spec:product.design_records.spec_format`.
...
|---|---|
| `product/records/spec/design-records/spec-format/index.md` | `spec:product.design_records.spec_format` |
| `product/records/spec/design-records/traceability/semantic-ref.md` | `spec:product.design_records.traceability.semantic_ref` |
| `drmcp/records/spec/design-records-mcp/tools.md` | `spec:drmcp.design_records_mcp.tools` |

The canonical grammar source is `spec:product.design_records.spec_format.spec_id_as_ref`.
...
The spec status lifecycle is defined by `spec:product.design_records.spec_format`. `draft` is the current documented status for specs under active development.
...
| `spec:product.design_records.spec_format` | Normative spec format contract. |
| `spec:product.design_records.spec_format.spec_id_as_ref` | Path-derived canonical ref rules and parent grammar. |
| `spec:product.design_records.spec_format.document_shape` | H1 format, metadata markers, kind set, section matrix. |
| `spec:product.design_records.spec_format.topics_table` | `## Topics` table contract and validation rules. |
| `spec:product.design_records.spec_format.validation_policy` | Severity rules during migration phase. |
