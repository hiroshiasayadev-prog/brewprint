...
| `spec:product.design_records.namespace_model.artifact_id_grammar` | ADR ID grammar. |
| `spec:product.design_records.repository_layout.record_discovery_paths` | ADR discovery path rules. |
