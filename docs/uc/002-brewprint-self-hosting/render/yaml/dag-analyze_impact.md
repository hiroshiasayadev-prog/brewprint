...
flowchart TD
  subgraph params
    request([request: analyze_impact_request])
  end

  _start([Start]) ==> validate_request[validate_request]
  request --> validate_request
  validate_request --> validated_request([validated_request: analyze_impact_request])
  ...
  build_response --> response([response: analyze_impact_response])
