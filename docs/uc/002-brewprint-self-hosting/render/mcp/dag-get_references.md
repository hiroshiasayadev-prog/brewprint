...
flowchart TD
  subgraph params
    request([request: get_references_request])
  end

  _start([Start]) ==> validate_request[validate_request]
  request --> validate_request
  validate_request --> validated_request([validated_request: get_references_request])
  ...
  build_response --> response([response: get_references_response])
