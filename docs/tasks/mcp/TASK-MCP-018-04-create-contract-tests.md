# TASK-MCP-018-04: Implement strict create contract and regression tests
...
- `TASK-MCP-018-02` の影響調査に基づき、既存 tests / runtime smoke を strict contract に合わせて更新する。
...
- Spec was not changed in this task; it used the completed `TASK-MCP-018-03` contract.
- Runtime smoke / close synchronization remains for `TASK-MCP-018-05`.
