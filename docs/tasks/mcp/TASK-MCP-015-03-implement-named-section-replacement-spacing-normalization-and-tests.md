# TASK-MCP-015-03: Implement named section replacement spacing normalization and tests
...
Implement the minimal `named_section_replace` spacing normalization and add regression tests that protect the behavior required by `REQ-MCP-016`.
