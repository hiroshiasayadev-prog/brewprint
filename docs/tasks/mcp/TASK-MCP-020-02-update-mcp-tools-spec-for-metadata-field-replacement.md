# TASK-MCP-020-02: Update MCP tools spec for metadata field replacement
...
- Review the updated spec against `REQ-MCP-020` acceptance criteria.
...
REQ-MCP-020 acceptance criteria coverage:
