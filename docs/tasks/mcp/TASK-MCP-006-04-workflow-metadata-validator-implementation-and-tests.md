# TASK-MCP-006-04: Workflow metadata validator 実装と tests を追加する
...
TASK-MCP-006-02 / TASK-MCP-006-03 で確定・反映した public contract に合わせて、Design Records MCP の workflow artifact metadata parser / validator / MCP tests を実装する。
...
1. TASK-MCP-006-03 の spec / guidance update を読む。
