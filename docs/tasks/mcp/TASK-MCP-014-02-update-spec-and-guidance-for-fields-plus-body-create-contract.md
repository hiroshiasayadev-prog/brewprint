# TASK-MCP-014-02: Update spec and guidance for fields plus body create contract
...
- Left Go implementation unchanged; implementation remains owned by `TASK-MCP-014-03`.
...
- Design Records MCP `validate_records(kind=task, id_range=TASK-MCP-014-01..TASK-MCP-014-04)`
