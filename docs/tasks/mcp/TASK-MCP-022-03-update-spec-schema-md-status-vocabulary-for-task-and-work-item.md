# TASK-MCP-022-03: update spec schema.md status vocabulary for task and work_item
...
`docs/spec/design-records-mcp/schema.md` の status テーブルおよび関連記述を ADR-094 の決定内容に合わせて更新する。
