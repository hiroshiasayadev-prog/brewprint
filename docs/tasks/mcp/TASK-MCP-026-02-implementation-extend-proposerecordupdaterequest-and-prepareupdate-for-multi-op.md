# TASK-MCP-026-02: implementation — extend ProposeRecordUpdateRequest and prepareUpdate for multi-op
...
deferred work（複数セクション replace 対応）は TASK-MCP-026-02 本文の Evidence 末尾に記載済み。
