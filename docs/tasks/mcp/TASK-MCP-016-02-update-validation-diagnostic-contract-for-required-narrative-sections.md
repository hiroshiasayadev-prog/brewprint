# TASK-MCP-016-02: Update validation diagnostic contract for required narrative sections
...
- Review the updated spec text against the policy matrix from `TASK-MCP-016-01`.
...
Policy matrix carried forward from `TASK-MCP-016-01`:
