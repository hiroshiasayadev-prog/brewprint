# TASK-MCP-019-03: Add regression tests for required heading case canonicalization
...
Add regression tests that lock the REQ-MCP-021 spec contract before implementation.
...
- Tests express the current spec/schema contract clearly enough for implementation in TASK-MCP-019-04.
...
Implementation input for `TASK-MCP-019-04`:
