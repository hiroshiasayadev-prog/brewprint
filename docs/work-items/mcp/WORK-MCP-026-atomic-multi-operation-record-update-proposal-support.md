# WORK-MCP-026: atomic multi-operation record update proposal support
...
TASK-MCP-026-01 → TASK-MCP-026-02 → TASK-MCP-026-03 → TASK-MCP-026-04 → TASK-MCP-026-05

TASK-MCP-026-01 完了後にユーザーが spec を確認してから TASK-MCP-026-02 に入る（ゲート A）。
...
- 全テスト通過
- REQ-MCP-025 が `accepted` になっている

## Evidence

2026-06-07: 全タスク完了。

- TASK-MCP-026-01: spec 更新（operations array contract 追加）
- TASK-MCP-026-02: 実装（ProposeRecordUpdateRequest + proposeMultiOpUpdate + prepareMultiOpUpdate + detectOperationConflicts）
- TASK-MCP-026-03: テスト11件追加・全件 PASS
- TASK-MCP-026-04: スモークテスト [6]-[9] 追加・全9件 PASS
- TASK-MCP-026-05: クローズ同期
