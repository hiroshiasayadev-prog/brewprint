# WORK-MCP-017: Warn on workflow artifact exact ID create sequence gaps
...
WORK-MCP-017 is closed on 2026-06-03. TASK-MCP-017-01 through TASK-MCP-017-04 are complete, tests passed, and TASK-MCP-017-04 records runtime smoke evidence for exact ID gap warning behavior.

## Progress Boundary

Do not reopen WORK-MCP-014. Treat this as a follow-up authoring feedback improvement for REQ-MCP-018.
