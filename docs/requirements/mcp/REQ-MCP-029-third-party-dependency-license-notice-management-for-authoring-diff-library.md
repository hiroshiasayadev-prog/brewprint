# REQ-MCP-029: third-party dependency license notice management for authoring diff library
...
This requirement is captured because TASK-MCP-023-03 adopted `github.com/pmezard/go-difflib/difflib` for git-style unified diff generation. The dependency uses the BSD 3-Clause license, which permits source and binary redistribution but requires retaining the copyright notice, license conditions, and disclaimer. Binary redistribution also requires reproducing those notices in documentation or other materials.
...
During REQ-MCP-027 implementation, the project chose to use `github.com/pmezard/go-difflib/difflib` rather than hand-rolling complex unified diff logic.
