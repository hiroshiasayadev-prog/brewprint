...
> 由来: V01-ADR-043 §1。`master.yaml` 不在は V01-ADR-002 §決定 で当初定めた `master.yaml` を V01-ADR-043 が覆した結果。
...
> 由来: V01-ADR-002 §決定, V01-ADR-043 §1
...
> 由来: V01-ADR-043 §4, M8-8 project renderer fixture 固定
...
> 由来: V01-ADR-046 §5, M8-8 project renderer fixture 固定
